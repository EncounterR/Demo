...
<script type="text/javascript">
	...
	function add() {
		console.log("add");
		var str="<tr id=><td><b>属性名称</b></td><td><input type='text' name='spec_names' class='layui-input' value=''></td><td><a onclick='del(this)' class='btn btn-default'>删除</a></td></tr>";
		...
		<div class="larry-personal">
			...
			<div class="larry-personal-body clearfix">
				<form class="layui-form col-lg-5"
					action="${basePath}doAddProductSpec.action" method="post"
					...
					<div class="layui-form-item">
						<table class="layui-table" id='wu'>
							<tr>
								<td><b>属性名称</b></td>
								<td><input type="text" name="spec_names" class="layui-input" value=""></td>
							</tr>
						</table>
					</div>
					<div class="layui-form-item">
